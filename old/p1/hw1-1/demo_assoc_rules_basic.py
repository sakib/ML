...
#implement tim's idea of dealing with Nonetypes by cumulatively adding a set of [0,#options-for-q1,#options-for-q1+q2,etc], calculating rules, and converting back
#also, figure out how the params work
